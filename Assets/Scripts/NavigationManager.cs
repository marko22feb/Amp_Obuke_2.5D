...
public class NavigationManager : MonoBehaviour
{
    ...
    {
        navObj = nav;
        GameController.control.GetComponent<PlayerController>().inputType = PlayerController.InputType.UI;
        Cursor.visible = true;
    ...
    public void Update()
    {
       if( GameController.control.GetComponent<PlayerController>().inputType == PlayerController.InputType.UI)
        {
